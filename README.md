...
- Learn and apply React fundamentals such as components, props, state, and hooks.

- Build a responsive, single-page layout suitable for desktop and mobile devices.

- Practice organizing a project with a clean folder structure, reusable components, and modular code.

- Showcase my web development projects and make it easy for recruiters or visitors to understand my technical abilities.

- Gain experience in deploying a React app online and managing static assets like images and PDFs.
